 ...
 * http://www.lac.inpe.br/~rafael.santos/JIPCookbook.jsp for information on
 * usage and distribution. Rafael Santos (rafael.santos@lac.inpe.br)
 */
...
/**
 * This application creates signatures for each class for a parallelepiped
 * classifier. Please see http://www.lac.inpe.br/~rafael.santos/JIPCookbook.jsp
...
public final class CreateParallelepipedSignatures {
     ...
     * image file name, the name of the file with the description of the
     * classes, and the name of the file with the coordinates for the samples.
     * 
     * @throws IOException
     */
    public static void main( String[] args ) throws IOException {
        ...
        br.close();
        // Create the structures to represent the bounds for the
        // parallelepipeds,
        ...
        for ( Integer classIndex : classMap.keySet() ) {
            minMap.put( classIndex, new int[] { 1000, 1000, 1000 } ); // large
                                                                      // enough
            maxMap.put( classIndex, new int[] { -1, -1, -1 } ); // small enough
        }
        // Open the file with the coordinates and get the pixels' values for
        // those
        // coordinates.
            ...
            if ( c != null ) // We have a region!
            {
                ...
                for ( int row = 0; row <= h; row++ )
                    for ( int col = 0; col <= w; col++ ) {
                        ...
                        // Use those values to adjust the bounds for the
                        // parallelepipeds.

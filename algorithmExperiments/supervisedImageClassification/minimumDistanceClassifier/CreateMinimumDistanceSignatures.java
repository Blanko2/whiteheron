...
/**
 * This application creates signatures for each class for a minimum distance
 * classifier. Please see http://www.lac.inpe.br/~rafael.santos/JIPCookbook for
 * more information on the files and formats used in this class.
 */
public final class CreateMinimumDistanceSignatures {
    ...
    public static void main( String[] args ) throws IOException {
        ...
        br.close();
        // Create the structures to represent the signature for the minimum
        // distance
        // classifier: the average value of the pixels in the samples for each
        // class.
